...
import chakra from "../../../assets/icons/chakra-icon.svg";
import i18 from "../../../assets/icons/i18n-icon.svg";
import jwt from "../../../assets/icons/jwt-icon.svg";
import knex from "../../../assets/icons/knex-icon.svg";
import metabase from "../../../assets/icons/metabase-icon.svg";
import swagger from "../../../assets/icons/swagger-icon.svg";
...
export const icons: { icon: string; onClick: () => void }[] = [
  ...
  },
  {
    icon: reactNative,
    onClick: () => {
      window.open("https://reactnative.dev/");
    },
  },
  {
    icon: git,
  ...
  },
  {
    icon: jest,
    onClick: () => {
      window.open("https://jestjs.io/pt-BR/");
    },
  },
  {
    icon: firebase,
    onClick: () => {
      window.open("https://firebase.google.com/?hl=pt-br");
    },
  },
  {
    icon: vue,
